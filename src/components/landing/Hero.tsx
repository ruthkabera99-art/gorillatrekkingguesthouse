    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <motion.p
          ...
          className="text-sm md:text-base tracking-[0.3em] uppercase text-white/70 font-sans mb-4"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-white/80 font-sans font-light max-w-2xl mx-auto mb-10"
        >
        ...
        >
          <Button
            size="lg"
            className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-6 text-base font-sans tracking-wide shadow-luxury"
          >
            Book Your Stay
          </Button>
          <Button
            variant="outline"
            size="lg"
            className="border-white/30 text-white hover:bg-white/10 px-10 py-6 text-base font-sans tracking-wide backdrop-blur-sm"
          >
            Explore Rooms
          </Button>
        </motion.div>
